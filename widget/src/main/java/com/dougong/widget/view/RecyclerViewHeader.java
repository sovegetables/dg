...
public class RecyclerViewHeader extends RelativeLayout {
    ...
    private boolean useCustomHeight = false;
    ...
    protected final void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && isAttachedToRecycler) {
            ...
            recyclerView.onHeaderSizeChanged(useCustomHeight ? customHeight : getHeight() + verticalMargins, getWidth() + horizontalMargins);
            onScrollChanged();
        }
    }
