...
public abstract class AdapterDelegate<T> {
    ...
    private static final int TAG_ID =  R.id.id_holder_view;
    private static final int TAG_POSITION_ID =  R.id.id_holder_positon;
    int viewType;
    ...
    public static void setItemTag(RecyclerView.ViewHolder holder, Object obj){
        holder.itemView.setTag(TAG_ID, obj);
    }

    public static void setPositionTag(RecyclerView.ViewHolder holder, int position){
        holder.itemView.setTag(TAG_POSITION_ID, position);
    }

    public static int getPositionByTag(View itemView){
        return (int) itemView.getTag(TAG_POSITION_ID);
    }

    @SuppressWarnings("unchecked")
    public static <T> T getItemByTag(RecyclerView.ViewHolder holder){
        return (T) getItemByTag(holder.itemView);
    }

    @SuppressWarnings("unchecked")
    public static <T> T getItemByTag(View itemView){
        return (T) itemView.getTag(TAG_ID);
    }
     ...
     */
    protected void onBindViewHolder(T items, @NonNull RecyclerView.ViewHolder holder, int position, List payloads){
        this.onBindViewHolder(items, holder, position);
    }

    protected abstract void onBindViewHolder(T items, @NonNull RecyclerView.ViewHolder holder, int position);
