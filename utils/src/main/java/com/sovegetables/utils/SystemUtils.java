...
public final class SystemUtils {
     ...
     */
    public static boolean isOnTop(Context context, Class<? extends Activity> activityClass) {
        try {
    ...
    public static void showKeyboard(EditText editView) {
        if (editView != null) {
            //设置可获得焦点
            ...
            //调用系统输入法
            InputMethodManager inputManager = (InputMethodManager) editView
