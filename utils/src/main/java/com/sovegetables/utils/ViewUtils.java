...
public class ViewUtils {
    ...
    public static void highLightFirstTextView(TextView tv){
        SpannableStringBuilder sp = new SpannableStringBuilder(tv.getText());
        sp.setSpan(new QMUITouchableSpan(ContextCompat.getColor(tv.getContext(), R.color.qmui_config_color_red),
                ContextCompat.getColor(tv.getContext(), R.color.qmui_config_color_red),
                Color.TRANSPARENT, Color.TRANSPARENT){
            @Override
            public void onSpanClick(View widget) {
            }
        }, 0, 1, SpannableStringBuilder.SPAN_EXCLUSIVE_EXCLUSIVE);
        tv.setText(sp);
    }
